#ifndef ALGEBRAICSAMPLINGPARALLEL_H
#define ALGEBRAICSAMPLINGPARALLEL_H
 ...
 */
void initialize_function_sample(monomial_term *term_list, uint32_t list_size, function_sample *sample, const char **argv);
